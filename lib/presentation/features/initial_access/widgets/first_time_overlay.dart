...
class FirstTimeOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ModalTemplate(
      isReverse: false,
      hideTopBadge: true,
      header: context.localizations.overlay_first_time_title,
      description: context.localizations.overlay_first_time_message,
