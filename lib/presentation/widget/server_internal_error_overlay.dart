...
class ServerInternalErrorOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ModalTemplate(
      ...
      header: context.localizations.something_went_wrong_modal_title,
      description: context.localizations.server_internal_error_description,
      hideTopBadge: true,
      isReverse: false,
    );
  }
