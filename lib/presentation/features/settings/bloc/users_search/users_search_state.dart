...
class UsersSearchState with _$UsersSearchState {
  const factory UsersSearchState({
    required ScreenStatus screenStatus,
    required List<UserSearch> suggestedUsers,
    required UserSearch? selectedUser,
    required bool isButtonEnabled,
    required int numberOfResults,
    required bool isUserAdded,
  }) = _UsersSearchState;

  factory UsersSearchState.initial() => const UsersSearchState(
