  ...
  Widget build(BuildContext context) {
    return AFDataCard(
      title: AFDataCardTitle(
        section:
            context.localizations.cert_card_emitter(certificate.emitterName),
        title: certificate.holderName,
        subtitle: context.localizations
            .cert_card_valid_date(certificate.expirationDate),
        iconRightAsset: _iconPath,
        subSection: context.localizations.certificateUsages(certificate.usages),
      ),
      //Saves currently selected certificate
      onTap: onTap,
    );
  }
}
