...
class PushRemoteDataSource implements PushRemoteDataSourceContract {
  final PushApiContract _api;

  PushRemoteDataSource(this._api);
  ...
  Future<bool> registerPush({
    ...
    final response =
        await _api.registerPush(sessionId: sessionId, petition: petition);
  ...
  Future<bool> updatePush({
    ...
    final response =
        await _api.updatePush(sessionId: sessionId, status: status);
