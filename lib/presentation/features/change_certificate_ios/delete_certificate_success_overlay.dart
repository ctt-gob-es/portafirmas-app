...
class DeleteCertificateSuccessOverlay extends StatelessWidget {
  final String certName;
  const DeleteCertificateSuccessOverlay({Key? key, required this.certName})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ModalTemplate(
      ...
      description: context.localizations
          .certificate_deleted_overlay_success_subtitle(certName),
      mainButtonText: context.localizations.general_understood,
      mainButtonFunction: () => context.pop(),
      iconPath: Assets.iconDelete,
      header: context.localizations.certificate_deleted_overlay_success_title,
    );
  }
}
