...
part 'filter_init_data.freezed.dart';

@freezed
class FilterInitData with _$FilterInitData {
  const factory FilterInitData({
    required RequestStatus requestStatus,
    required RequestFilter initFilter,
    required bool isValidatorProfile,
  }) = _FilterInitData;
}
