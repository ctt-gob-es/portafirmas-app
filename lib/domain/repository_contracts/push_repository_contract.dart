...
abstract class PushRepositoryContract {
  Future<bool> requestPermissionsAndInitialize(
    MessageReceived onReceiveMessage,
  );
  Future<PermissionStatus> requestPermissions();
  Future<String?> checkNotificationPermStatus();

  Future<void> unRegisterDevice();

  Future<Result<bool>> updatePush({
    required bool
        status, //true (notifications unmuted), false (notifications muted)
  });
