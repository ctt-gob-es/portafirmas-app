...
import 'package:portafirmas_app/presentation/features/change_certificate_ios/change_certificate_screen.dart';

class ChangeCertificateScreenProvider extends StatelessWidget {
  final _getIt = GetIt.instance;
  ChangeCertificateScreenProvider({
    super.key,
  });
  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => _getIt<ChangeCertificateBloc>()
            ..add(const ChangeCertificateEvent.loadAllCertificates()),
        ),
      ],
      child: const ChangeCertificateScreen(),
    );
  }
}
