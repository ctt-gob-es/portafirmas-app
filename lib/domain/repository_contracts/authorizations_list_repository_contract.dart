...
abstract class AuthorizationsRepositoryContract {
  Future<Result<List<AuthDataEntity>>> getAuthorizationsList();
  Future<Result<bool>> addAuthorization(
    NewAuthorizationUserEntity user,
  );
  Future<Result<bool>> revokeAuthorization(String id, String operation);
  Future<Result<bool>> acceptedAuthorization(String id);
}
