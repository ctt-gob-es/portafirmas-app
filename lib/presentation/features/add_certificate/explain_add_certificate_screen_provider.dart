...
class ExplainAddCertificateScreenProvider extends StatelessWidget {
  final _getIt = GetIt.instance;
  ExplainAddCertificateScreenProvider({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => _getIt<AddCertificateBloc>(),
      child: const ExplainAddCertificateScreen(),
    );
  }
}
