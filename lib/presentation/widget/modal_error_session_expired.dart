...
class ModalErrorSessionExpired {
  static modalSessionExpired(BuildContext context) {
    return showModalBottomSheet(
      ...
      builder: (context) => ModalTemplate(
        ...
        mainButtonFunction: () => context.logout(),
        iconPath: Assets.iconAlertCircle,
        header: context.localizations.expired_session_modal_header,
        description: context.localizations.expired_session_modal_description,
        hideTopBadge: true,
        isReverse: true,
      ),
    );
