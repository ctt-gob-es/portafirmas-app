...
class CertAddedErrorScreen extends StatelessWidget {
  const CertAddedErrorScreen({super.key});
          ...
          children: [
            Padding(
              ...
              child: SvgPicture.asset(
                width: 70,
                height: 70,
                Assets.iconErrorCircle,
                excludeFromSemantics: true,
              ),
            ),
            CustomTitleSubtitleBox(
              title: context.localizations.cert_error_adding_title,
              subtitle: context.localizations.cert_error_adding_subtitle,
